...
object OpenAPIPolicyGenerator {
    ...
    const val POLICY_NAME = "The name of the policy"
    const val POLICY_CATEGORY = "The category of the policy"
    const val POLICY_DESCRIPTION = "The policy is generated by the OpenAPIPolicyGenerator"
