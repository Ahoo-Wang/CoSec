...
class CoSecAuthorizationAutoConfiguration {
    ...
    class WebMvc {
        ...
        fun servletRequestParser(
            requestTenantIdParser: RequestTenantIdParser<HttpServletRequest>,
            servletRemoteIpResolver: RemoteIpResolver<HttpServletRequest>
        ): RequestParser<HttpServletRequest> {
            return ServletRequestParser(requestTenantIdParser, servletRemoteIpResolver)
        }
    ...
    class WebFlux {
        ...
        fun reactiveRequestParser(
            reactiveRequestTenantIdParser: RequestTenantIdParser<ServerWebExchange>,
            reactiveRemoteIpResolver: RemoteIpResolver<ServerWebExchange>
        ): RequestParser<ServerWebExchange> {
            return ReactiveRequestParser(reactiveRequestTenantIdParser, reactiveRemoteIpResolver)
        }
